...
The scope is `user`, meaning the context ID is `((author.id))` by default. This function does not return any output — it performs a sislow write operation. Use $getUserVar to read the value back.
