...
- **With message**: `$cooldown[10s;⏳ Attendez 10 secondes.]` — sends the message and stops.
- **Without message**: `$cooldown[10s]` — stops silently, the user sees nothing.
...
```
$cooldown[30s;⏳ Cooldown actif. Réessayez dans $getCooldown secondes.]
$onlyIf[$message!=;❌ Vous devez fournir un message.]
