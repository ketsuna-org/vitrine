---
layout: default
title: Créez des bots Discord depuis un espace de travail visuel
description: Bot Creator aide les équipes à créer des commandes, gérer des workflows et piloter des bots Discord depuis une application professionnelle.
locale: fr
...
<section class="site-grid page-section pb-24">
    ...
    <div class="hero-layout" style="grid-template-columns: minmax(0, 1.1fr) minmax(24rem, 1.3fr); align-items: center;">
      <div class="hero-copy">
        <div class="eyebrow-row mb-2">
          <span class="eyebrow-pill shadow-[0_0_15px_rgba(143,43,223,0.3)]">Constructeur Professionnel</span>
          <span class="meta-chip border-white/10 bg-white/5">Contrôle local</span>
        </div>
        <h1 class="text-transparent bg-clip-text bg-gradient-to-br from-white to-purple-200 tracking-tight leading-[1.05] pb-2">
          L'automatisation Discord, sans le chaos.
        </h1>
        <p class="lede text-purple-100/70 text-lg mb-6">
          Bot Creator aide les équipes à créer des commandes, gérer des workflows et piloter vos bots Discord depuis un espace de travail premium. Gardez les opérations en local jusqu'à ce que vous ayez besoin d'hébergement.
        </p>
        <div class="button-row mb-8">
          ...
          <a class="button button-secondary px-8 py-3 text-lg bg-white/5" href="{{ t.paths.guides | relative_url }}">Lire la Doc</a>
        </div>
        <div class="hero-points flex flex-wrap gap-3">
          <span class="hero-point bg-white/5 border-white/10 text-white shadow-sm">Création visuelle</span>
          <span class="hero-point bg-white/5 border-white/10 text-white shadow-sm">Dashboard intégré</span>
          <span class="hero-point bg-white/5 border-white/10 text-white shadow-sm">App Mobile & Desktop</span>
        </div>
      </div>
            ...
            <div class="flex-1 bg-[#150a25] flex flex-col relative overflow-hidden">
               ...
               <div class="flex-1 p-6 flex flex-col items-center overflow-y-auto z-10">
                  ...
                  <div class="w-full max-w-[340px] mb-5">
                     <div class="text-white/50 text-[11px] font-bold tracking-widest uppercase mb-3 px-1">Accès Rapide</div>
  ...
  <section class="section-shell relative z-10" data-reveal>
    <div class="section-header">
      ...
      <h2 class="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200">Une façon plus claire de livrer une automatisation Discord.</h2>
      <p class="section-intro">Le produit est pensé pour les équipes qui veulent un workflow fiable, du premier setup aux opérations quotidiennes.</p>
    </div>
    <div class="feature-grid mt-8">
      <article class="feature-card">
        <h2 class="text-purple-100 flex items-center gap-2"><div class="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.3)]"><svg class="w-4 h-4 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg></div> Conception visuelle</h2>
        <p class="mt-4">Construisez slash commands, options et logique de réponse sans perdre de vue permissions, variables et enchaînements.</p>
      </article>
      <article class="feature-card">
        <h2 class="text-purple-100 flex items-center gap-2"><div class="w-8 h-8 rounded-lg bg-orange-500/20 flex items-center justify-center border border-orange-500/30 shadow-[0_0_15px_rgba(249,115,22,0.3)]"><svg class="w-4 h-4 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg></div> Codez avec BDScript</h2>
        <p class="mt-4">Écrivez votre code en utilisant le célèbre langage de script de Bot Designer For Discord, puissant et accessible.</p>
      </article>
      <article class="feature-card">
        <h2 class="text-purple-100 flex items-center gap-2"><div class="w-8 h-8 rounded-lg bg-blue-500/20 flex items-center justify-center border border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.3)]"><svg class="w-4 h-4 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg></div> Contrôle au quotidien</h2>
        <p class="mt-4">Gardez démarrage, logs, synchronisation et contrôles dans le même produit que celui utilisé pour construire le bot.</p>
      </article>
      <article class="feature-card">
        <h2 class="text-purple-100 flex items-center gap-2"><div class="w-8 h-8 rounded-lg bg-green-500/20 flex items-center justify-center border border-green-500/30 shadow-[0_0_15px_rgba(34,197,94,0.3)]"><svg class="w-4 h-4 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01"></path></svg></div> Évolution sans infrastructure</h2>
        <p class="mt-4">Commencez en local, validez le workflow, puis ajoutez Linux ou Docker quand l'hébergement devient un besoin réel.</p>
      </article>
    </div>
  </section>
  ...
  <section class="section-shell relative z-10" data-reveal>
    <div class="split-grid">
      <article class="panel-card flex flex-col justify-center">
        <p class="section-label">Contrôle & Propriété</p>
        <h2 class="text-3xl font-bold mt-4 mb-4">Gardez un workflow compréhensible.</h2>
        <p class="mb-6 text-purple-100/70">Bot Creator rassemble édition, contrôle et gestion des données pour éviter les scripts dispersés, dashboards annexes et colle technique.</p>
        <ul class="space-y-4">
          <li class="flex gap-3">
             ...
             <span class="text-white/80">Le stockage local est la base pour les commandes, workflows, variables et logs.</span>
          </li>
          <li class="flex gap-3">
             <svg class="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
             <span class="text-white/80">La sauvegarde Google Drive est optionnelle pour plus de portabilité.</span>
          </li>
          <li class="flex gap-3">
             <svg class="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
             <span class="text-white/80">Le runner Docker reste disponible quand l'uptime devient critique.</span>
          </li>
        </ul>
      </article>
      ...
      <div class="panel-stack">
        <article class="panel-card pb-8">
          <p class="section-label">Écosystème unifié</p>
          <h2 class="text-2xl font-bold mt-4 mb-3">Utilisez le même produit partout.</h2>
          <p class="mb-6">Commencez sur la plateforme qui correspond à votre travail quotidien.</p>
  ...
  <div class="cta-banner relative overflow-hidden flex flex-col items-center text-center py-16 mt-12" data-reveal>
    ...
    <div class="relative z-10 w-full max-w-2xl mx-auto flex flex-col items-center">
      <p class="section-label mb-6">Prêt à construire ?</p>
      <h2 class="text-4xl font-bold mb-6 tracking-tight">Créez un workflow bot clair et évolutif.</h2>
      <p class="text-lg text-purple-100/70 mb-8 max-w-xl">Commencez dans l'application, gardez le contrôle local, et ajoutez l'infrastructure du runner seulement quand c'est nécessaire.</p>
